...
parser.add_argument('--data_range', type=str, default='1-20000/1-100',
...
parser.add_argument('--model', default='OurNet',
                    help='model name')
...
parser.add_argument('--test_every', type=int, default=1500,
